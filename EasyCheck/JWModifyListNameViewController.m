//
//  JWModifyListNameViewController.m
//  EasyCheck
//
...
@interface JWModifyListNameViewController()<UITableViewDataSource,UITableViewDelegate>{
...
@implementation JWModifyListNameViewController
