...
@interface JWLockView()

@property (nonatomic, strong) NSArray* buttons; // 保存所有的按钮

@property (nonatomic, strong) NSMutableArray* selectedButtons; // 保存所有“碰过”的按钮

@property (nonatomic, strong) UIColor *lineColor;  // 定义一个线的颜色

@property (nonatomic, assign) CGPoint currentPoint;  // 记录最后用户触摸的点

@end

@implementation JWLockView
